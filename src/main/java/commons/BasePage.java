...
public class BasePage {
    ...
    public void inputToTextboxByItemName(WebDriver driver, String inputValue, String itemName) {
        waitForElementVisible(driver, BasePageUI.DYNAMIC_TEXTBOX_BY_TEXT, itemName);
        sendkeysToElement(driver, BasePageUI.DYNAMIC_TEXTBOX_BY_TEXT, inputValue, itemName);
    ...
    public void clickToButtonByValue(WebDriver driver, String value) {
        waitForElementClickable(driver, BasePageUI.DYNAMIC_BUTTON_BY_VALUE, value);
        clickToElement(driver, BasePageUI.DYNAMIC_BUTTON_BY_VALUE, value);
    }

    public String sendKeysRandomDate(WebDriver driver, String locator) {
        ...
        LocalDate startDate = currentDate.minusYears(80);
        LocalDate randomSDate;
        WebElement startDateElement = getWebElement(driver, locator);
        // Generate random dates within the range
        randomSDate = generateRandomDate(startDate, endDate);

        // Format the random dates
        String formattedRandomDate = dateFormat.format(java.sql.Date.valueOf(randomSDate));
        // Enter the random dates in both start and end date fields
        startDateElement.sendKeys(formattedRandomDate);
